...
import { CSSProperties, ElementType, useCallback, useEffect, useId, useMemo, useRef } from "react";
...
const MaskedHeading = ({
  ...
  const sync = useCallback(() => {
    ...
    root.style.fontSize = `${clamp(root.clientWidth * s.textScale, 20, 280).toFixed(1)}px`;
